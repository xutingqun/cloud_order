...
package com.cloud.order.view.time;
...
public class WheelView extends View {
	...
	private static final int VALUE_TEXT_COLOR = 0x66000000;
	...
	private void initResourcesIfNecessary() {
		if (itemsPaint == null) {
			...
			int mScreenheigth = DeviceUtils.getScreenHeight();
			if(mScreenheigth<=800){
				TEXT_SIZE = 20;
			}else if(mScreenheigth<=1280){
				TEXT_SIZE = 30;
			}else{
				TEXT_SIZE = 40;
			}
		...
		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(R.drawable.seekbar_bg);
		}
